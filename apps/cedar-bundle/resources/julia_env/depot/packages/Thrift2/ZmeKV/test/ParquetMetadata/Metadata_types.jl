...
mutable struct Column <: Thrift.TMsg
  meta::ThriftMeta
  values::Dict{Symbol,Any}
  
  function Column(; kwargs...)
    obj = new(__meta__Column, Dict{Symbol,Any}())
    values = obj.values
    symdict = obj.meta.symdict
    for nv in kwargs
      fldname, fldval = nv
...
const __meta__Column = meta(Column,
...
function Base.getproperty(obj::Column, name::Symbol)
  if name === :file_path
    return (obj.values[name])::String
...
meta(::Type{Column}) = __meta__Column
...
const __meta__RowGroup = meta(RowGroup,
  ...
  Type[Vector{Column},Int64,Int64,Vector{SortingColumn},Int64,Int64,Int16],
...
function Base.getproperty(obj::RowGroup, name::Symbol)
  if name === :columns
    return (obj.values[name])::Vector{Column}
